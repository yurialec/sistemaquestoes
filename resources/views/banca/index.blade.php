                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                        <div>
                            <p class="text-sm text-gray-600">
                                @if($bancas->total() > 0)
                                    Mostrando <span class="font-medium">{{ $bancas->firstItem() }}</span>
                                    a <span class="font-medium">{{ $bancas->lastItem() }}</span>
                                    de <span class="font-medium">{{ $bancas->total() }}</span> registros
                                @else
